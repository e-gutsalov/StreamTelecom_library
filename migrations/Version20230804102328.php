 ...
 */
final class Version20230804102328 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE discard_book (id INT AUTO_INCREMENT NOT NULL, book_id INT DEFAULT NULL, reason VARCHAR(255) DEFAULT NULL, INDEX IDX_A7B9B20316A2B381 (book_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE discard_book ADD CONSTRAINT FK_A7B9B20316A2B381 FOREIGN KEY (book_id) REFERENCES book (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE discard_book DROP FOREIGN KEY FK_A7B9B20316A2B381');
